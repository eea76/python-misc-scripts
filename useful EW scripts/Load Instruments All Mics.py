...
def onMain():
    ...
    batch = BatchHarness(r"/Volumes/Mavericks/Users/elon/Desktop/QL Pianos Platinum/QL Pianos Instruments/Bosendorfer 290")
    batch.openLog(r"/Users/elon/Desktop/Bosen.txt")
    batch.logLoads = True
