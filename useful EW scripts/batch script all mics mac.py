...
def onMain():
    ...
    batch = BatchHarness(r"/Volumes/2TB Mac/Play Libraries/EWQL Hollywood Brass Diamond/Hollywood Brass Instruments")
    batch.openLog(r"/Users/elon/Desktop/HBDiamond.txt")
    batch.logLoads = True
    # optional: batch.abortOnException = True
    batch.go()
    batch.closeLog()
    print("All done. Please check log in Play Pro for any errors.")
