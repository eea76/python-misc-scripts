...
class BatchBitch:
    ...
    def go(self, files, **kwargs):
        ...
        self.outfile = open(r"C:\Users\JK X64\Desktop\solo violin download.txt", "w")#, encoding="utf-8")
        for fpath in files:
            self._clear()
            self._load(fpath)
            #self._set()
...
#ROOT = ''
ROOT = r"C:\Users\JK X64\Desktop\old\Libraries\QL Solo Violin\QL Solo Violin Instruments"
