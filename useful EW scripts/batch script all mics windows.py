...
def onMain():
    ...
    batch = BatchHarness(r"C:\Users\JK X64\Desktop\old\Libraries\QL Pianos Platinum\QL Pianos Instruments\Yamaha C7")
    batch.openLog(r"C:\Users\JK X64\Desktop\Yamaha.txt")
    batch.logLoads = True
